...
namespace CaterUI
{
    public partial class NOPITest : Form
    {
        public NOPITest()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //保存工作本
            FileStream stream = new FileStream(@"C:\Users\20733\Desktop\t1.xls", FileMode.Create);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //1.1读取文件
            using (FileStream stream = new FileStream(@"C:\Users\20733\Desktop\t1.xls", FileMode.Open))
            {
                //1.2创建workbook
